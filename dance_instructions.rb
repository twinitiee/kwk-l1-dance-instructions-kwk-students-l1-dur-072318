...
def gangnam style dance
  Step 1. Plant legs far apart, bend knees slightly and keep posture loose
  Step 2. Lift right follow_redirect
  Step 3. Return right foot to the ground
  Step 4. Finishing with a small skip-step backward
  Step 5. Lower left foot to the ground
  Step 6. Bounce left foot back up slightly
  Step 7. Left, Right, Left, and Left
  Step 8. Lower right foot to the ground
  Step 9. Bounce right foot back up slightly, kicking it a few inches back
